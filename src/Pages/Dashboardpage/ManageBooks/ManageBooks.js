		...
		fetch(url, {
			...
			.then(result => {
				if (result.success) {
					...
					axios
						.post(
							`https://neighbour-home-backend.onrender.com/book/`,
							bookInfo
						)
						.then(data => {
	...
	return (
		<div className="sm:px-10 px-2 pb-5">
			...
			<div className="flex justify-between">
				<h5 className="text-lg font-bold  mb-2 text-primary">
					Manage Books
				</h5>
				...
				<table className="w-full  text-left ">
					<thead className="text-sm font-bold uppercase  bg-gray-200 text-gray-600">
						<tr>
							<th
								scope="col"
								className="py-2 sm:py-3 text-center font-bold"
							>
								Book Name
							</th>
							...
							fetch(url, {
								...
								.then(result => {
									...
									if (result.success) {
										...
										axios
											.put(
												`https://neighbour-home-backend.onrender.com/book/${_id}`,
												bookInfo
											)
											.then(data => {
												toast.success(
						...
						const deleteBook = (id, name) => {
							Swal.fire({
								...
								if (result.isConfirmed) {
									axios
										.delete(
											`https://neighbour-home-backend.onrender.com/book/${id}`
										)
										.then(data => {

                    ...
                    <tbody>
                        {data?.map((user, i) => {
                            ...
                            return (
                                <tr
                                    key={user._id}
                                    className={`${darkMode ? " bg-gray-800 border-gray-700 odd:bg-gray-800 even:bg-gray-700" : "border-b odd:bg-white even:bg-gray-50"}   `}
                                >
                                    <th
                                        scope='row'
                                        className={`${darkMode ? "text-white" : "text-gray-900"}  px-3 sm:pr-0 sm:pl-8 py-2  sm:py-4 font-medium  whitespace-nowraptext-[13px]`}
                                    >
                                        {i + 1}
                                    </th>
                                    ...
                                    <td className='py-2 text-[13px] sm:py-4 text-center'>
                                        {user?.role === 'admin' ?
                                            ...
                                            <button onClick={deleteAdmin} className={`${darkMode && "hover:text-white hover:btn-ghost"} btn btn-xs  btn-warning`}>
                                                Delete Admin
                                            </button>
                                            :
                                            ...
                                            <button
                                                onClick={makeAdmin}
                                                className={`${darkMode && "hover:text-white hover:btn-ghost"} btn btn-xs  btn-success`}>
                                                Make Admin
                                            </button>
                                        }
                                    </td>

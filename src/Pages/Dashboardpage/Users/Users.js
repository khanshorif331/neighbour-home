								...
								>
									...
									<td class='py-2 text-[13px] sm:py-4 text-center'>
										{user?.roll !== 'admin' && (
											<button
												onClick={makeAdmin}
												class='h-5 sm:h-6  sm:px-3 uppercase bg-green-400 border-none hover:bg-green-600 rounded-full text-white'
											>
												Make Admin
											</button>
										)}
									...
									>
										<button class='h-5 sm:h-6  sm:px-3 uppercase bg-red-500 border-none  hover:bg-red-800 rounded-full text-white'>
											Delete Admin
										</button>
									</td>
								</tr>

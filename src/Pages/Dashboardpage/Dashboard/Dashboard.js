...
const Dashboard = () => {
     ...
     return (
          <div style={{ fontFamily: "'Rajdhani', sans-serif" }} className='sm:mt-[129px] mt-[80px] mt-[80px]'>
               <div class="drawer drawer-mobile mt-[64px]">
                    ...
                    <div class="drawer-side">
                         ...
                         <ul className={`${darkMode ? "bg-[#171e36] text-gray-300" : "bg-white  text-base-content"} menu p-4 overflow-y-auto w-80 `}>
                              ...
                              <li><Link className='shadow-lg my-1' to={"/dashboard/manageBooks"}>Manage Books</Link></li>

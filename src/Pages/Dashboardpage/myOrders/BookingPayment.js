        ...
        <div>
            <div className="card w-50 max-w-md my-12 bg-base-100 shadow-xl">
                <div className="card-body">
                    <p className='text-success font-bold'>Hello, {booking?.data?.customerName}</p>
                    <h2 className="card-title">Please Pay for {booking?.engineer?.name}</h2>
                    <p>Please Pay: <span className='text-error'>${booking?.price}</span> For Hiring this Engineer</p>
                </div>
            </div>

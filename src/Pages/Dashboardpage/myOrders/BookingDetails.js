...
const BookingDetails = () => {
	...
	const { isLoading, error, data, refetch } = useQuery(['booking'], () =>
		fetch(`https://neighbour-home-backend.onrender.com/booking/${id}`).then(
			res => res.json()
		)
	)
	...
	return (
		<div className="lg:px-2 px-8 py-6 pb-32 h-full">
			<div className="text-5xl text-accent pb-2 text-center">
				Booking Details
			</div>
			<div className="card rounded-none  bg-white shadow-xl">
				<div className="bg-gray-200">
					<div className="text-3xl text-accent font-semibold py-2 pl-2 border-b-2 border-gray-300">
						Engineer Info
					</div>{' '}
					<hr />
					<div className="flex justify-between">
						...
						<figure>
							<img
								className="w-40 h-40 text-left inline-block  p-4"
								src={photo}
								alt={name}
							/>
						</figure>
				...
				<div className="card lg:card-side">
					<div className="card-body">
						...
						<div className="text-xl  text-neutral">
							Date of birth:{' '}
							<span className="font-semibold">16 Sep 2001</span>
						</div>
						<div className="text-xl  text-neutral">
							Nationality:{' '}
							<span className="font-semibold">Bangladeshsi</span>
						</div>
						<div className="text-xl  text-neutral block">
					...
					<div className="card-body">
						...
						<div className="text-2xl text-accent font-bold uppercase">
						...
						<div className="text-xl  text-neutral">
							...
							<a
								...
								target="_blank"
								href="https://autostars.netlify.app"
							>
								https://autostars.netlify.app
							</a>
						</div>
						<div className="text-xl  text-neutral">
							Travelu:{' '}
							<a
								className="text-primary"
								target="_blank"
								href="https://traveluu.netlify.app"
							>
								https://traveluu.netlify.app
							</a>
						</div>
						<div className="text-xl  text-neutral">
							GamesReview:{' '}
							<a
								className="text-primary"
								target="_blank"
								href="https://gamesreview.netlify.app"
							>
								https://gamesreview.netlify.app/
							</a>
						</div>
					</div>
				</div>
				<div className="mx-4">
					<div className="text-3xl border-b-2 border-gray-600 text-accent font-semibold py-2 pl-2">
						My Info
					</div>
					<figure>
						<img
							className="w-40 h-40 text-left block mr-auto p-4"
							src={user?.photoURL}
							alt="Nayeem Hasan"
						/>
					</figure>
				...
				<div className="card lg:card-side">
					<div className="card-body">
						<div className="text-xl  text-neutral">
							Name: <span className="font-semibold">{customerName}</span>
						</div>
						<div className="text-xl  text-neutral">
							Date of birth:{' '}
							<span className="font-semibold">16 Sep 2001</span>
						...
						<div className="text-xl  text-neutral">
							<small>
								Linkedin:{' '}
								<span className="font-semibold">
									/{customerName.toLowerCase().split(' ')}
								</span>
							</small>
						</div>
						<div className="text-xl  text-neutral">
						...
						<Link to={`/user_data`}>
							<button
								className={`{${
									...
									role !== 'Worker' &&
									'block'
								} hidden btn btn-md text-end btn-error mt-auto`}
							>
								update your info
							</button>
						</Link>

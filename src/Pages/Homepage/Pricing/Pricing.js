            ...
            {/* <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 transform hover:scale-105 transition duration-500">
              ...
              >
                ...
                <p className="mt-3 leading-relaxed text-gray-600">
                  This package is for small business. If you want to growth your
                  company quickly please upgrade your package.
                </p>
                <ul className="flex-1 mb-6 text-gray-600">
                  ...
                  <li className="flex mb-2 space-x-2">
                    ...
                    <span>contact with engineers</span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="flex mb-2 space-x-2">
                    ...
                    <span>And more updated features</span>
                  </li>
                </ul>
                <button
                  type="button"
            ...
            {/* <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 transform hover:scale-105 transition duration-500">
              ...
              >
                ...
                <p className="leading-relaxed text-gray-600">
                  This package is for Large scale company who can only get our
                  fully premium package.
                </p>

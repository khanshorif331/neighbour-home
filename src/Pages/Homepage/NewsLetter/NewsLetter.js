                    ...
                    <div>
                         ...
                         <Fade bottom duration='2000'>
                              <form onSubmit={handleSubmit} style={{ fontFamily: 'Open Sans,sans-serif' }} >
                                   ...
                                   <button type='submit' style={{ fontFamily: 'Open Sans, sans-serif', letterSpacing: '2px' }} class=" transition w-32 sm:w-40 mx-auto text-center bg-white text-emerald-900  hover:bg-teal-900 hover:text-white rounded-full  border-2 border-primary py-1.5 sm:py-2.5 ml-[-40px]">Subscribe</button>
                              </form>
                         </Fade>
                    </div>
               </div>

...
const UserData = () => {
	...
	return (
		<section className="sm:mt-[129px] mt-[80px]">
			<h1
				className={`text-4xl text-center my-3 ${darkMode && 'text-white'}`}
			>
				Welcome To Neighbour Home!
			</h1>
			<div className="border p-7 rounded-lg cs-card-shadow w-full md:w-2/3 mx-auto my-3">
				...
				>
					Fill Up This Form For Next Step
				</h1>
				<div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-7">
							...
							<div>
								...
								<select
									...
									className="select mt-1 px-3 py-2 border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 w-full rounded-md sm:text-sm focus:ring-1"
								>

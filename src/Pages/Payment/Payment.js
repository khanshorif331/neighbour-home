...
const Payment = () => {
	...
	const { id } = useParams()
	useEffect(() => {
		const url = `https://neighbour-home-backend.onrender.com/sellPost/${id}`
	...
	return (
		<div
			...
			className="mt-[129px]"
		>
			<div className="flex justify-evenly flex-col-reverse sm:flex-row py-16 w-11/12 sm:container mx-auto">
				<div className="flex flex-col p-2 sm:p-10 sm:text-left text-center sm:mt-0 mt-3 md:flex-row md:w-8/12  rounded-lg bg-white shadow-lg">
					<div className="w-11/12 mx-auto sm:mx-0 mb-10 sm:mb-0 sm:w-4/12 text-center">
						...
						<img
							className="w-56   mx-auto sm:w-full h-32 sm:h-96 md:h-48 object-cover md:w-56 rounded-t-lg md:rounded-none md:rounded-l-lg"
							src={images}
							alt=""
						/>

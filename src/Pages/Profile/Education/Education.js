			...
			<div>
				...
				{toogleEducationEdit ? (
					<div className="">
						<button
							onClick={() =>
								setToogleEducationEdit(!toogleEducationEdit)
							}
							className="text-sm bg-red-600   text-center px-5 py-2 rounded-full text-white font-medium my-3 cursor-pointer ml-4"
						>
							{' '}
							Cancel Edit
						</button>
					...
					<div className="">
						<button
							...
							className="text-sm bg-blue-600   text-center px-5 py-2 rounded-full text-white font-medium my-3 cursor-pointer ml-4"
						>
							{' '}
							Edit Education
						</button>
